...
public class CaptureSoundController extends JComponent {	
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                CaptureSoundController meter = new CaptureSoundController();
    ...
    static class Recorder implements Runnable {
        final CaptureSoundController meter;

        Recorder(final CaptureSoundController meter) {
            this.meter = meter;
        }
        ...
        public void run() {
        	...
        	AudioFormat fmt = model.SoundModel.getAudioFormat();
